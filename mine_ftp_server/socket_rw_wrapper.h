#ifndef SOCKET_RW_WRAPPER_H
#define SOCKET_RW_WRAPPER_H

#include <unistd.h>     /*for ssize_t*/
#include <netinet/in.h> /*fro sockaddr*/
#include <dirent.h>     /*for DIR*/

#define MAXLINE 1024    /*BUF'S MAX SIZE*/
#define LISTENQ 1024    /*MAX LISTEN QUEUE*/
#define SERV_PORT 9877  /*DEFAULT LISTEN PORT*/
#define MAXSOCKADDR 128 /*?*/

#define max(a, b) ((a)>(b)?(a):(b))
#define min(a, b) ((a)<(b)?(a):(b))

#define FILE_MODE (S_IRUSER | S_IWUSR | S_IRGRP | S_IROTH)
